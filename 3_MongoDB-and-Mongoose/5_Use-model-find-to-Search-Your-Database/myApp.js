...
/*
let dave = new Person({name : "Dave", age: 27, favoriteFoods: ["pizza", "chocolate"] });
console.log(dave);
*/
...
let arrayOfPeople = [
  ...
  { name: "Garry", age: 55, favoriteFoods: ["fried chicken", "chicken wings", "chicken nuggets"] },
...
//some example :
let secondArrayOfPeople = [
  { name: "Evelyne", age: 35, favoriteFoods: ["fried chicken", "chicken wings", "chicken nuggets"] },
  { name: "Evelyne", age: 55, favoriteFoods: ["fried chicken", "chicken wings", "chicken nuggets"] },
  { name: "Pauline", age: 24, favoriteFoods: ["watermelon", "mango"] },
  { name: "François", age: 52, favoriteFoods: ["vegetable soup"] }
];

Person.create(secondArrayOfPeople, (error, data) => {
  if(error){
    console.log(error)
  }
  else{
...
Person.find({name: "Evelyne"}, (error, data)=> {
  if(error){
    console.log(error)
  }
  else
...
Person.find({name: "Evelyne" , age:55}, (error, data)=> {
  if(error){
    console.log(error)
  }
  else
